...
function mod_bumpyperiod(po,val,spd)
	po:BumpyPeriod(val,spd)
end
function mod_bumpyx(po,val,spd)
	po:BumpyX(val,spd)
end
function mod_bumpyxperiod(po,val,spd)
	po:BumpyXPeriod(val,spd)
end
...
function mod_confusionoffset(po,val,spd)
	po:ConfusionOffset(val,spd)
end
function mod_stealthtype(po,val,spd)
	po:StealthType(val > 0)
end
function mod_stealthpastreceptors(po,val,spd)
	po:StealthPastReceptors(val > 0)
end
